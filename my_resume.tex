...
\end{itemize}
\textbf{SCONE} \textit{Scalable Contrastive Orientation for Causal Discovery (\href{https://arxiv.org/abs/2603.03411v1}{paper})}
\begin{itemize}
    \itemsep -0.5em \vspace{-0.5em}
    \item Developed a scalable causal discovery framework for paired observational and interventional data with unknown, soft multi-target intervention effects, using contrastive cross-regime orientation rules to recover larger causal graphs
\end{itemize}
